                ...
                switch (_socket.State)
                {
                    case WebSocketState.Open:
                        ...
                        if (received.EndOfMessage && memoryStream.Position == 0)
                        {
                            ...
                            var data = JsonSerializer.Deserialize<JsonElement[]>(array.AsSpan(0, received.Count))!;
                        ...
                        if (received.EndOfMessage)
                        {
                            ...
                            var data = JsonSerializer.Deserialize<JsonElement[]>(memoryBuffer.AsSpan(0, (int)memoryStream.Position))!;
                            OnMessage?.Invoke(this, data);
